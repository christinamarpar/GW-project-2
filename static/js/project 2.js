...
function updateMetadata(sample){
    ...
    Plotly.d3.json(sampleURL,function(error,response){
        ...
        metaList.innerHTML = '';
        var metaItems = [["Row Labels"],["lifetime_risk_maternal_death"],["pregnant_women_receiving_prenatal_care"],["prevelance_of_anemia_among_pregnant_women"]];
